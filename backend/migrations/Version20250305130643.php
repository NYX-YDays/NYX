 ...
 */
final class Version20250305130643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, birthday_date DATE DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, sex VARCHAR(255) DEFAULT NULL, bio LONGTEXT DEFAULT NULL, password_hash VARCHAR(255) NOT NULL, is_pro TINYINT(1) NOT NULL, phone INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
